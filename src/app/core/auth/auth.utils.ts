...
export class AuthUtils {
    ...
    static isTokenExpired(token: string, offsetSeconds?: number): boolean {
        ...
        try {
            ...
            // If any error occurs (e.g. invalid/non-JWT token), we can't check
            // its expiration locally. In this case, we return false (not expired)
            // and let the server handle the validation.
            return false;
        }
    }
